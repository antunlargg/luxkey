...
*   **Direct In-App GitHub Synchronization:** Instantly upload and propose newly discovered verified backlight nodes directly to any selected GitHub repository as structured issues.
